...
angular.module("myapp")
    .constant("categoriesUrl", "docs/json/categories.json")//定义URL常量
    .constant("productsUrl", "docs/json/products.json")//定义URL常量
    .constant("orderUrl", "docs/json/order.json")//定义URL常量
